...
|---|---|---|---|---|---|
| **🔷통합** | **100.0%** | **96.9%** | 93.3% | **85,472** | **82,823** |
| 유찬 | 100.0% | 97.3% | 84.2% | 68,263 | 66,389 |
| 이지현 | 97.8% | 95.7% | 93.1% | 76,851 | 73,558 |
| 임지현 | 98.2% | 97.3% | 94.7% | 82,035 | 79,801 |

→ 통합은 단일 크롤러 최대치(임지현 82,035셀/79,801정답)를 상회하는 **85,472 비교셀 / ~82,823 정답셀**을 커버리지 100%로 수집 = "누락 없이 최다 데이터" 달성.
→ 통합 셀 일치율 **94.2%(v1) → 96.9%**: codex 학습(best_row·반올림합의·trust)과 claude 반영교과·전형명 정규화로 두 구현 모두 초과. **codex와 head-to-head는 `docs/comparison-vs-codex.md`** (claude 96.9 vs codex 96.72, 분류축 보존으로 데이터 손실 없이 우위).
