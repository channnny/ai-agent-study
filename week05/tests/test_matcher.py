...
def golden_mini():
    return {
        "테스트대학교": _mk([
            {"대학": "테스트대학교", "전형": "일반", "모집단위": "수학과", "모집인원": 10, "경쟁률": 5.5},
            {"대학": "테스트대학교", "전형": "일반", "모집단위": "물리학과", "모집인원": 8, "경쟁률": 4.2},
            {"대학": "테스트대학교", "전형": "일반", "모집단위": "화학과", "모집인원": 6, "경쟁률": 3.1},
            {"대학": "테스트대학교", "전형": "지역", "모집단위": "수학과", "모집인원": 3, "경쟁률": 2.5},
            {"대학": "테스트대학교", "전형": "지역", "모집단위": "물리학과", "모집인원": 2, "경쟁률": 1.8},
        ])
    }
...
def person_mini():
    ...
    return {
        "테스트대학교": _mk([
            {"대학": "테스트대학교", "전형": "일반", "모집단위": "수학과",   "모집인원": 10, "경쟁률": 5.5},  # 완벽 일치
            {"대학": "테스트대학교", "전형": "일반", "모집단위": "물리학과", "모집인원": 8,  "경쟁률": 4.5},  # 경쟁률 mismatch
            {"대학": "테스트대학교", "전형": "일반", "모집단위": "화학과",   "모집인원": 5,  "경쟁률": 3.1},  # 모집인원 mismatch
            {"대학": "테스트대학교", "전형": "신규", "모집단위": "통계학과", "모집인원": 4,  "경쟁률": 2.0},  # 골든에 없음 (extra)
            {"대학": "테스트대학교", "전형": "신규", "모집단위": "지구과학", "모집인원": 3,  "경쟁률": 1.5},  # 골든에 없음 (extra)
        ])
    }
...
class TestEvaluatePersonMini:
    ...
    def test_by_university(self, golden_mini, person_mini):
        r = evaluate_person(golden_mini, person_mini, "tester")
        uni = r.by_university.get("테스트대학교")
